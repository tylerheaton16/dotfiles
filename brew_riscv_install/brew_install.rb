...
BREW_REPO = "git://github.com/Homebrew/brew".freeze
if mac?
...
Your Mac OS X version is too old. See:
  #{Tty.underline}git://github.com/mistydemeo/tigerbrew#{Tty.reset}"
  EOABORT
...
system "/bin/touch", "#{HOMEBREW_CACHE}/.cleaned" if File.directory? HOMEBREW_CACHE

if should_install_command_line_tools?
  ohai "Searching online for the Command Line Tools"
  # This temporary file prompts the 'softwareupdate' utility to list the Command Line Tools
  clt_placeholder = "/tmp/.com.apple.dt.CommandLineTools.installondemand.in-progress"
  sudo "/bin/touch", clt_placeholder
...
#{Tty.bold}Read the analytics documentation (and how to opt-out) here:
  #{Tty.underline}git://docs.brew.sh/Analytics#{Tty.reset}

EOS

ohai "Homebrew is run entirely by unpaid volunteers. Please consider donating:"
puts <<-EOS
  #{Tty.underline}git://github.com/Homebrew/brew#donations#{Tty.reset}
EOS
...
- Install the Homebrew dependencies if you have sudo access:
  ...
  See #{Tty.underline}git://docs.brew.sh/linux#{Tty.reset} for more information.
...
puts "    #{Tty.underline}git://docs.brew.sh#{Tty.reset}"
