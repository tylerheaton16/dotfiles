...
#git_clone_or_update https://aur.archlinux.org/rxvt-unicode-patched.git
#git_clone_or_update https://github.com/blueyed/PKGBUILD-rxvt-unicode-wide.git
#git_clone_or_update https://aur.archlinux.org/rxvt-unicode-wcwidthcallback.git
pushd .
